...
test("Dynamo repositoryはtoken由来キーとProjectionだけを使いwhitelistする", async () => {
  ...
  assert.deepEqual(Object.keys(result).sort(), ["cancel_at_period_end","current_period_end","current_period_start","deep_enabled","extra_voice_remaining","membership_schema_version","membership_source","membership_updated_at","membership_version","monthly_voice_limit","monthly_voice_used","plan","subscription_status"].sort());
