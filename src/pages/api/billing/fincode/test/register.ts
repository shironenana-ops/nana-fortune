...
export const POST: APIRoute = ({ request }) => handleFincodeTestRegistration(request, testEnvironment, undefined, lightStore());
export const ALL: APIRoute = ({ request }) => handleFincodeTestRegistration(request, testEnvironment, undefined, lightStore());
